...
struct render_handler_ogles : public gameswf::render_handler
{
	...
	struct fill_style
	{
		...
		// Set OpenGL state for a necessary second pass.
		{
            ...
            GLfloat color[4];
            color[0] = m_bitmap_color_transform.m_[0][1]/255.0;
            color[1] = m_bitmap_color_transform.m_[1][1]/255.0;
            color[2] = m_bitmap_color_transform.m_[2][1]/255.0;
            color[3] = m_bitmap_color_transform.m_[3][1]/255.0;
	...
	// Set the given color.
	{
      ...
      //glColor4f(1, 1, 1, 1);
          ...
          glBlendColor(c.m_r, c.m_g, c.m_b, c.m_a);
